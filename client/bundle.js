...
BufferSingleton.prototype.bufferCall = function (call, timeout) {
    ...
    var removeCall=setTimeout(function(){
        var thunk = self.removeCall(currentId);
...
BufferSingleton.prototype.removeCall = function (id) {
    var pos, result;
...
HandlerNode.prototype.handleException = function (target) {
    ...
    var lookupMethod = function (handlerMethod) {
        ...
        if (!calledSuper) {
            console.log('FINISHED',self.ctxt.currentHandlerConstructor);
